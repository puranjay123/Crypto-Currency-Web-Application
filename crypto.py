...
image = Image.open('Binance.png')
st.image(image,width = 500)

st.title("Buy & sell Crypto in minutes")
st.markdown(""" Join the world's largest Crypto Exchange """)

expander_bar = st.expander("About")
expander_bar.markdown(""" Made By Puranjay Kwatra """)

#Dividing the page layout in three parts side bar, Data frame and bar chart.
col1 = st.sidebar
col2, col3 = st.columns((2,1))

col1.header('Input Options')  
currency_price_unit = col1.selectbox('Select Currency for Price',('INR','USD','BTC','ETH'))
